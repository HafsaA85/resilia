"""
Django settings for empowering_muslimahs_mind project.
...
ROOT_URLCONF = 'empowering_muslimahs_mind.urls'
...
WSGI_APPLICATION = 'empowering_muslimahs_mind.wsgi.application'
